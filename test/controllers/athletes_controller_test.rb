...
class AthletesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create athlete" do
    assert_difference("Athlete.count") do
      post athletes_url, params: { athlete: { bio: @athlete.bio, name: @athlete.name, user_id: @athlete.user_id } }
    end
  ...
  test "should update athlete" do
    patch athlete_url(@athlete), params: { athlete: { bio: @athlete.bio, name: @athlete.name, user_id: @athlete.user_id } }
