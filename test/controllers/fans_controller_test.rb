...
class FansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fan" do
    assert_difference("Fan.count") do
      post fans_url, params: { fan: { bio: @fan.bio, pseudo: @fan.pseudo, user_id: @fan.user_id } }
    end
  ...
  test "should update fan" do
    patch fan_url(@fan), params: { fan: { bio: @fan.bio, pseudo: @fan.pseudo, user_id: @fan.user_id } }
